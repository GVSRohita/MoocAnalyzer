...
app.use(function (req, res, next) {
    ...
    res.setHeader('Access-Control-Allow-Origin', 'https://cors-anywhere.herokuapp.com/http://mooc-analyzer.herokuapp.com/');
...
const subscriptionKey = '234c214a6506469db0a7426996db6d1f';

// You must use the same location in your REST call as you used to get your
// subscription keys. For example, if you got your subscription keys from
// westus, replace "westcentralus" in the URL below with "westus".
const uriBase = 'https://faceapiumkc.cognitiveservices.azure.com/face/v1.0/detect';
...
app.get('/videos/:video_id/users/:user_id/emotions', function(req, res){
    var video_id = req.params.video_id;
    var user_id = req.params.user_id;

    var db = firebase.database();
    var ref = db.ref("/videos/"+ video_id + "/users/"+ user_id);
...
app.get('/videos/:video_id/users/emotions', function(req, res){
    var video_id = req.params.video_id;
    
    var db = firebase.database();
    var ref = db.ref("/videos/"+ video_id + "/users/"+  "/");
    ref.once("value", function(snapshot) {
        res.send(snapshot.val());
      }, function (errorObject) {
        console.log("The read failed: " + errorObject.code);
